...
public class LibraryManagement extends JFrame {
    ...
    public void frameLayout() {
        ...
        sidePanel.setBackground(new Color(CONSTANTS.SIDE_COLOR[0], CONSTANTS.SIDE_COLOR[1], CONSTANTS.SIDE_COLOR[2]));
        sidePanel.setLayout(null);
        add(sidePanel);

        JPanel homePanel = new JPanel();
        homePanel.setBackground(new Color(CONSTANTS.SIDE_COLOR[0], CONSTANTS.SIDE_COLOR[1], CONSTANTS.SIDE_COLOR[2]));
        ...
        totalNumAvailBooksLabel.setBounds(CONSTANTS.LABEL_POS[0], CONSTANTS.LABEL_POS[1], CONSTANTS.LABEL_POS[2],
                CONSTANTS.LABEL_POS[3]);
